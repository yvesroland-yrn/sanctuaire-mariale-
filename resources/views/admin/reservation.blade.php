...
@section('page-subtitle', 'Suivi des demandes de réservation')
...
@section('content')
  ...
  <section class="admin-panel">
    <h2 style="font-size:1.05rem;font-weight:800;margin-bottom:10px;">Gestion des réservations</h2>
    <p style="color:#64748b;margin-bottom:0;">
      Cette page peut recevoir la liste des réservations dès que la base de données ou le formulaire est branché.
    </p>
